...
player_classes.each do |key, value|
  ...
  User.create(nickname: 'iAmUser1', email: 'test1@mail.com', password: 'password', password_confirmation: 'password', confirmed_at: Date.today)
  User.create(nickname: 'admin', email: 'admin@mail.com', role: 2, password: 'password', password_confirmation: 'password', confirmed_at: Date.today)
  user = User.first
